<!-- AUTONOMOUS VARIANT of claude/CLAUDE.md — symlinked to ~/.claude/CLAUDE.md by
`install.sh --autonomous`. Keep this identical to claude/CLAUDE.md EXCEPT the
"## Git Policy" paragraph (autonomous machines may run git themselves). When you
edit CLAUDE.md, mirror the change here. -->
