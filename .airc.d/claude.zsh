...
ANTHROPIC_DEFAULT_HAIKU_MODEL='openai/gpt-6-luna[1m]' \
ANTHROPIC_DEFAULT_SONNET_MODEL='xiaomi/mimo-v2.6-pro[1m]' \
ANTHROPIC_DEFAULT_OPUS_MODEL='openai/gpt-6-sol' \
CLAUDE_CODE_SUBAGENT_MODEL='xiaomi/mimo-v2.6-pro[1m]' \
